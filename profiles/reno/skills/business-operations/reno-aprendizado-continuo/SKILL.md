...
4. Consulte as skills relacionadas com `skills_list` e `skill_view`. Atualize a skill que já cobre o assunto com `skill_manage` em vez de criar uma duplicata. Crie uma nova somente se houver uma classe de tarefa distinta e reutilizável.
