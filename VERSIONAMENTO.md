...
- metadados mutáveis das skills (`.usage`, `.curator`, `.hub` e manifests),
  caches, dependências geradas, plugins e outras dependências instaladas
  automaticamente.
...
hashes registrados pelo Hermes nos respectivos `.bundled_manifest`, mas todas
as classificações de skill precisam estar visíveis ao Git. A auditoria percorre
também referências, scripts, templates e assets. Somente metadados mutáveis do
Hermes e artefatos gerados precisam continuar ignorados.
